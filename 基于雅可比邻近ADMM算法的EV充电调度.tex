...
&min \quad\sum_{n=1}^{N+1}y_{n,t}^2-2(x_{n,t}^k+U_{n,t}^k)y_{n,t}\\
...
\begin{array}l
  ...
  F=\rd{?}\,\,\|{u}\|_F=(\sum_{i=1}^p\sum_{j=1}^q a_{ij}^2)^{\frac{1}{2}}\\
\end{array}
\end{align}
(这里N为块数,\,矩阵的F范数和向量的2范数一致)
and the initial value
\begin{align}
&\mathbf{p}_n^0 =\mathbf{0},\quad \lambda^0 =?,\quad \varepsilon^{pri}= 10^{-3},\quad \rho =0.01, \quad\gamma=1
\end{align}
