...
定义增广拉格朗日函数如下:
\begin{align*}
\mathcal{L}_{\rho}(P,X,\mu)&=G(P)+\mathcal{I}_1(P)+\mathcal{I}_2(Y)+\mu^T(P-Y)+\frac{\rho}{2}\|P-Y\|_F^2\\
&=G(P)+\mathcal{I}_1(P)+\mathcal{I}_{2}(Y)+\frac{\rho}{2}\|P-Y+\frac{\mu}{\rho}\|_F^2-\frac{\rho}{2}\|\frac{\mu}{\rho}\|_F^2
\end{align*}
